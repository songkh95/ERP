    ...
    <div class="parts-tab-content">
        <div class="card">
            ...
            <div class="search-container" style="display:flex; gap:10px; margin-bottom:15px; background:#f8f9fa; padding:10px; border-radius:6px;">
                <select id="search-filter" class="form-input" style="width:120px; padding:8px; border:1px solid #ccc; border-radius:4px;">
                    ...
                    <option value="name">부품명</option>
                </select>
                <div style="position:relative; flex:1;">
                    <i class='bx bx-search' style="position:absolute; left:10px; top:10px; color:#999;"></i>
                    <input type="text" id="search-input" class="form-input" placeholder="모델명 또는 부품명 검색..." style="padding:8px 8px 8px 30px; width:100%; box-sizing:border-box; border:1px solid #ccc; border-radius:4px;">
                </div>
            </div>
                ...
                <table class="data-table" style="width:100%; border-collapse:collapse;">
                    <thead>
                        <tr style="background:#f1f3f5;">
                            ...
                            <th style="padding:15px; border:1px solid #ddd;">보유 부품 (클릭하여 상세 내역 확인)</th>
                        </tr>
                    </thead>
        ...
        <div id="parts-modal" class="modal-overlay" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:999; justify-content:center; align-items:center;">
            ...
            <div class="card" style="width:500px; max-width:90%; max-height:90vh; overflow-y:auto; margin:0; animation: slideDown 0.3s ease; background:white; padding:25px; border-radius:8px;">
                ...
                <form id="parts-form" onsubmit="return false;">
                    <input type="hidden" id="parts-id">
                    ...
                    <div class="form-group" style="margin-bottom: 20px; display:flex; flex-direction:column;">
                        ...
                        <input type="text" id="input-location" class="form-input" placeholder="예: B-3 선반" style="width:100%; padding:8px; border:1px solid #ccc; border-radius:4px;">
                    </div>
